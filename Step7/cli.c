...
int main(int argc, char *argv[])
{
   ...
   while (1)
   {
    ...
    //Conversion en network long avant d'envoyer sur le réseau
        UneRequete.Reference = htonl(UneRequete.Reference);
        UneRequete.Numero = htonl(UneRequete.Numero);
        UneRequete.Type = htonl(UneRequete.Type);
        ...
        UneRequete.Reference = ntohl(UneRequete.Reference);
        UneRequete.Numero = ntohl(UneRequete.Numero);
        UneRequete.Type = ntohl(UneRequete.Type);
